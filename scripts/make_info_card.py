...
# ===========================================================================
HOST = "shabadgrover"   # shown as  you@github  in the header

ROWS = [
    ("host",),

("kv", "Now", "B.Tech CSE @ LPU"),
("kv", "Focus", "AI | Data Science | Backend"),
("kv", "Role", "Associate Software Engineering Intern"),
("kv", "Company", "Eicore Technologies Pvt Ltd"),
("kv", "Edu", "Computer Science, Class of 2027"),
...
("kv", "Data", "Pandas, NumPy, Power BI"),
("kv", "ML", "Scikit-learn, TensorFlow"),
("kv", "Backend", "FastAPI, LangChain"),
("kv", "Tools", "Git, VS Code, MySQL"),

("gap",),

("sec", "Highlights"),

("bul", "Built an LLM Chatbot using FastAPI & Groq"),
("bul", "Developed an Ocular Micro-Trauma AI System"),
("bul", "Working on Insurance Fraud Analytics (FWA)"),
]
